...
cmd({
    ...
    try {
        ...
        await conn.sendMessage(m.chat, {
            image: { url: "https://i.ibb.co/Vcp3gdCN/67de846c2ade9.jpg" },
...
cmd(
    ...
    async (conn, mek, m, { from, isGroup, isBotAdmins, reply, sender, isOwner }) => {
        try {
            ...
            const staffContacts = [
                "923456751206@s.whatsapp.net", // Example: Add staff members here
            ];
...
cmd(
    ...
    async (conn, mek, m, { from, isGroup, isBotAdmins, isAdmins, reply, isOwner }) => {
        try {
            ...
            const imageUrl = "https://i.ibb.co/Vcp3gdCN/67de846c2ade9.jpg"; // Replace with the actual image URL
