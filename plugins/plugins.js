...
const REPO_OWNER = 'HamzaxAnees';
const REPO_NAME = 'ANEES-MD';
...
async (conn, mek, m, { from, reply }) => {
    try {
        ...
        let pluginList = "📂 *HAMZAxANEES MD PLUGINS:*\n\n";
...
async (conn, mek, m, { from, reply, args, senderNumber }) => {
    try {
        ...
        const statusMessage = {
            image: { url: `https://i.ibb.co/GvPprY7T/6845b83ba2c41.jpg` }, // Replace with your image URL
            ...
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    newsletterName: '𝐇αɱzαxAɳeeร̇ 𝐌Ɗ 𝐒ʊ̊𝐏𝐏๏፝֟ɼʈ 🍁',
                    serverMessageId: 143
                }
            }
        };
