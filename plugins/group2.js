...
cmd({
    ...
    try {
        ...
        const channelLink = "https://whatsapp.com/channel/0029Vad17wh1CYoLkhzgKN0Z";
...
cmd({
    ...
    try {
        ...
        const supportLink = "https://chat.whatsapp.com/ICBBSOzhsPcCiuuxOFLW4e";

        // Send the support link to the user
        reply(`*ɴᴇᴇᴅ ʜᴇʟᴘ ᴏʀ ʜᴀᴠᴇ ǫᴜᴇsᴛɪᴏɴs ? ᴊᴏɪɴ ANEES sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ🪀*\n\n${supportLink}\n\n
